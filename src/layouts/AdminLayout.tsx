  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50/50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <aside className={`${
          ...
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            {!isCollapsed && (
              <div className="text-left animate-in fade-in slide-in-from-left-2 duration-300">
                <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 tracking-tight flex items-center gap-1.5">
                  EduGrade <ShieldCheck className="w-4 h-4 text-violet-500 shrink-0" />
                </h2>
                <p className="text-xs text-muted-foreground font-semibold">Admin Workspace</p>
              </div>
            )}
          </div>
          <button
        ...
        {/* BOTTOM LOGOUT */}
        <div className={`p-4 border-t border-slate-100 dark:border-slate-800 ${isCollapsed ? 'flex flex-col items-center' : ''}`}>
          <button
            onClick={logout}
            ...
            {isCollapsed ? (
              <div className="flex items-center gap-3 animate-in fade-in slide-in-from-left-4 duration-300">
                ...
                <div className="text-left hidden sm:block">
                  ...
                  <p className="text-[10px] text-muted-foreground font-semibold mt-1">Admin Control Panel</p>
                </div>
              </div>
            ) : null}
          </div>
